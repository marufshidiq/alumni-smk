...
<head>
    ...
    <title>Page not found | Sistem Informasi Alumni SMK N 1 Klaten</title>
    ...
    <div class="error-pagewrap">
		<div class="error-page-int">
			<div class="content-error">
				...
				<a href="/">Dashboard</a>
				<a href="https://github.com/marufshidiq/alumni-smk/issues" target="_blank">Report Problem</a>
			</div>
			<div class="text-center login-footer">
				<p>Copyright © 2019. All rights reserved.<br/> <a target="_blank" href="https://github.com/marufshidiq/alumni-smk">SIA @version('version-compact')</a> - MRFSHDQ </p>
			</div>
		</div>   
    </div>
    <!-- jquery
