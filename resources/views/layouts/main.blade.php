...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="{{route('dashboard')}}"><img class="main-logo" src="/main/img/logo/logo.png" alt="" /></a>
                <strong><a href="{{route('dashboard')}}"><img src="/main/img/logo/logosn.png" alt="" /></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    @include('layouts.metis-nav')
                </nav>
            </div>
        </nav>
    </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<img src="/avatar/{{\Auth::user()->photo}}" alt="" />
                                                ...
                                                <!-- <li class="nav-item nav-setting-open"><a href="/main/#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="educate-icon educate-bell"></i></a>

                                                    <div role="menu" class="admintab-wrap menu-setting-wrap menu-setting-wrap-bg dropdown-menu animated zoomIn">
                                                        <ul class="nav nav-tabs custon-set-tab">
                                                            <li class="active"><a data-toggle="tab" href="/main/#Notes">Notes</a>
                                                            </li>
                                                            <li><a data-toggle="tab" href="/main/#Projects">Projects</a>
                                                            </li>
                                                            <li><a data-toggle="tab" href="/main/#Settings">Settings</a>
                                                            </li>
                                                        </ul>
                                                                        ...
                                                                        <ul class="notes-menu-list">
                                                                            <li>
                                                                                <a href="/main/#">
                                                                                    <div class="notes-list-flow">
                                                                                        <div class="notes-img">
                                                                                            <img src="/main/img/contact/4.jpg" alt="" />
                                                                                        </div>
                                                                            ...
                                                                            <li>
                                                                                <a href="/main/#">
                                                                                    <div class="notes-list-flow">
                                                                                        <div class="notes-img">
                                                                                            <img src="/main/img/contact/2.jpg" alt="" />
                                                                                        </div>
                                                                                        <div class="notes-content">
                                                                                            <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                            <span>Yesterday 2:45 pm</span>
                                                                            ...
                                                                            <li>
                                                                                <a href="/main/#">
                                                                                    <div class="notes-list-flow">
                                                                                        <div class="notes-img">
                                                                                            <img src="/main/img/contact/3.jpg" alt="" />
                                                                                        </div>
                                                                                        <div class="notes-content">
                                                                                            <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                            <span>Yesterday 2:45 pm</span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            @yield('breadcumb')
                                            <!-- <li><a href="/main/#">Home</a> <span class="bread-slash">></span>
                                            </li>
    ...
    <!-- calendar JS
		============================================ -->
    <script src="/main/js/calendar/moment.min.js"></script>
    <script src="/main/js/calendar/fullcalendar.min.js"></script>
    <script src="/main/js/calendar/fullcalendar-active.js"></script>
    <!-- plugins JS
		============================================ -->
